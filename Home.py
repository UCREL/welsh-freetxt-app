...
with st.container():
    ...
    with left_column:
        ...
        st.markdown(
            f'<span class="title"><a href="https://ucrel-welsh-freetxt-app-home-i3gq4l.streamlit.app/Reviews_analysis_&_illustrations"><img width="200" height="200" src="data:image/gif;base64,{data_url} "></a></span>',
            unsafe_allow_html=True,  
                )
    with right_column:
        ...
        st.markdown(
            f'<a href="https://ucrel-welsh-freetxt-app-home-i3gq4l.streamlit.app/Positive_and_Negative_reviews"><img width="200" height="200" class="title" src="data:image/gif;base64,{data_url_2} "></a>',
            unsafe_allow_html=True, 
                )
#######################
st.write("---")
with st.container():
    ...
    with left_column:
        ...
        st.markdown(
            f'<a href="https://ucrel-welsh-freetxt-app-home-i3gq4l.streamlit.app/Generate_a_summary"><img width="400" height="400" class="title" src="data:image/gif;base64,{data_url} "></a>',
            unsafe_allow_html=True,  
                )
    with right_column:
        ...
        st.markdown(
            f'<a href="https://ucrel-welsh-freetxt-app-home-i3gq4l.streamlit.app/Word_Types_and_Relations"><img width="500" height="500" class="title" src="data:image/gif;base64,{data_url_2} "></a>',
            unsafe_allow_html=True, 
                )
