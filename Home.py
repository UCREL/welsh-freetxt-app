...
with st.container():
    ...
    with left_column:
        ...
        st.markdown(
            f'<span class="title"><a href="https://ucrel-welsh-freetxt-app-home-i3gq4l.streamlit.app/Reviews_analysis_&_illustrations"><img width="200" height="200" class="img-container" src="data:image/gif;base64,{data_url} "></a></span>',
            unsafe_allow_html=True,  
                )
    with right_column:
